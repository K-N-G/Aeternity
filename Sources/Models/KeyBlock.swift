...
public struct KeyBlock: Codable, Hashable {
    ...
    public init(hash: String, height: ModelUInt64, prevHash: String, prevKeyHash: String, stateHash: String, miner: String, beneficiary: String, target: ModelUInt32, pow: [ModelUInt32]? = nil, nonce: ModelUInt64? = nil, time: ModelUInt64, version: ModelUInt32, info: String) {
        self.hash = hash
        self.height = height
