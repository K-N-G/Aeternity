...
public struct ChannelSettleTx: Codable, Hashable {
    ...
    public init(channelId: String, fromId: String, initiatorAmountFinal: ModelUInt, responderAmountFinal: ModelUInt, ttl: ModelUInt64? = nil, fee: ModelUInt, nonce: ModelUInt64) {
