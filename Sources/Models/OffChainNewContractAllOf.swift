//
// OffChainNewContractAllOf.swift
//
...
public struct OffChainNewContractAllOf: Codable, Hashable {
    ...
    public init(owner: String, vmVersion: ModelUInt16, abiVersion: ModelUInt16, code: ByteCode, deposit: ModelUInt, callData: String) {
        self.owner = owner
