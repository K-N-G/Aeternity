...
public struct OffChainCallContract: Codable, Hashable {
    ...
    public init(op: String, caller: String, contract: String, abiVersion: ModelUInt16, amount: ModelUInt, gas: ModelUInt64, gasPrice: ModelUInt, callData: String) {
        self.op = op
        self.caller = caller
